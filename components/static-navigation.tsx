...
// This is a static version of the navigation component without any animations or framer-motion dependencies
    ...
    <>
      ...
      {isMenuOpen && (
        <>
          ...
          <div className="fixed top-0 left-0 z-50 h-full w-[280px] bg-background shadow-lg">
      ...
      {showFloatingAction && (
        <button
          className="fixed bottom-20 left-1/2 -translate-x-1/2 z-50 h-14 w-14 rounded-full bg-gradient-to-r from-primary to-primary/80 text-primary-foreground shadow-md flex items-center justify-center"
