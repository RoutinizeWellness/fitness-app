...
import { AmateurZeroExerciseLibrary } from "@/components/training/amateur-zero-exercise-library"
...
export default function AmateurZeroExercisesPage() {
  const { user } = useAuth()
  ...
  useEffect(() => {
    const checkUserLevel = async () => {
      ...
      try {
        ...
        // Si no es amateur_zero, redirigir a la biblioteca de ejercicios regular
