...
import SpanishFoodDatabase from "@/components/nutrition/spanish-food-database"

export default function SpanishFoodsPage() {
      ...
      <header className="fixed top-0 left-0 right-0 z-50 bg-[#FFF5EB]">
        <div className="container max-w-md mx-auto px-4 h-16 flex items-center justify-between">
          <div className="flex items-center">
            ...
            <h1 className="text-xl font-bold text-[#573353]">Alimentos Españoles</h1>
          </div>
        </div>
      </header>
